                            ...
                            if(isset($show['success'])){
                                ...
                                foreach($show['success'] as $value){
                                    ...
                                    if(isset($value['share_text'])){
                                       ...
                                       echo "<pre><div><h2>Share By || $value[share_by]</h2></div>
                                        <div><h2>share||$value[share_text]</h2></div>
                                       <script>
                                    ...
                                    echo "<pre><div><h2>Share By || $value[share_by]</h2></div>
                                        <div><h2><img src='image/$value[share_pic]' width=300 height=300 ></h2></div>
                                       <script>
                                                $(document).ready(function(){
                                                  $('#button$value[share_id]').click(function(){
                                                    $.post('comment.php',
                        ...
                        <div class="container-fluid">
                            ...
                            <ul class="nav user_menu pull-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['group_name'];?><b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                        ...
                        <div class="antiscroll-content">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            <a href="#collapseLong" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
                                                <i class="icon-leaf"></i>Group Information
                                            </a>
                                        </div>
                            ...
                            if(isset($create_group['success']))
                              foreach($create_group['success'] as $value ){
                               echo "<li><a href=group_admin.php?group_id=$value[Email]&group_name=$value[First_Name] target=_blank>$value[First_Name]</a></li>";
