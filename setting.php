...
<?php
   ...
   error_reporting(0);   
    ...
    $deactivate=$user->setting($_SESSION['email'],$_POST['deactivate'],NULL,$_POST['hide']);
		...
		<div id="maincontainer" class="clearfix">
            ...
            <div id="contentwrapper">
                <div class="main_content">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <h3 class="heading">Account Setting</h3>
                            <div class="row-fluid">
                                <div class="span8">
                                    <form class="form-horizontal"  action="setting.php" method="POST"  enctype="multipart/form-data">
                                        <fieldset>
                                           ...
                                           <div class="control-group formSep">
                                                <label class="control-label">Deactivate my account</label>
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <input type="radio" value="yes" id="s_male" name="deactivate"  />
                                                        Yes
                                                    </label>
                                                    <label class="radio inline">
                                                        <input type="radio" value="no" id="s_female" name="deactivate" checked="unchecked"/>
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                             <div class="control-group formSep">
                                                <label class="control-label">I want hide(your are not come into search result)</label>
                                                <div class="controls">
                                                    <label class="radio inline">
                                                        <?php if($personal['success']['0']['in_search_result']=='yes')
                                                        {
                                                       echo "<input type=radio value=yes  name=hide  checked=unchecked/>Yes";
                                                       }                                                   
                                                    else 
                                                    {
                                                    
                                                        echo "<input type=radio value=no  name=hide checked=unchecked />
                                                        No";
                                                        }?>
                                                    </label>
                                            ...
                                            <div class="control-group formSep">
                                                ...
                                                <div class="controls">
                                                    <div class="sepH_b">
                                                        <input type="password" id="u_password" class="input-xlarge" name="Password" value="" />
                                            ...
                                            <div class="control-group formSep">
                                                <label for="u_signature" class="control-label">Any message</label>
                                                <div class="controls">
                                                    <textarea rows="4" id="u_signature" class="input-xlarge" name="sign"></textarea>
