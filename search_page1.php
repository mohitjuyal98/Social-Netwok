...
if(isset($_POST['submit'])){
    ...
    $user->join_group($_POST['id'],$_POST['g_name'],$_POST['email'],$_SESSION['email']);
}
    ?>
<html lang="en">
    <head>
                        ...
                        <div class="container-fluid">
                            ...
                            <nav>
                                <div class="nav-collapse">
                                    <ul class="nav">
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle" href="#"><?php if(count($req_list1)>0) echo count($req_list1);?> Friends request <b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                <?php
                                                        if(isset($req_list['success'])){
                                                        ...
                                                        echo "<div class='alert alert-error'>                                
                                                                 <strong><li>No friend request found </li>!</strong></div>";   
                                                    }
                                                ?>         
                                            </ul>
                                        </li>
            ...
            <div id="contentwrapper">
                <div class="main_content">
                    ...
                    <div class="row-fluid search_page">
                        <div class="span12">
                            <h3 class="heading"><small>Search results for</small> <?php echo $_POST['find'];?></h3>
                            <div class="well clearfix">
                                <div class="row-fluid">
                                    <div class="pull-left">Showing Results <?php echo count($search1['success']);?></div>
                             ...
                             <div class="search_panel clearfix">
                                ...
                                foreach($search1['success'] as $value){
                                   ...
                                   <span class='searchNb'>1</span>
                                    ...
                                    elseif(in_array($name,$_SESSION['friend'])){
                                   ...
                                   <span class='searchNb'>1</span>
                                    ...
                                    <div class='search_content'>
                                        ...
                                        <p class='sepH_b item_description'>$value[Email]</p>
                                        <p class='sepH_a'><strong>$value[sign]</strong> dolor sit amet</p>
                                        <small><a href='message.php?friend_id=$value[Email]' class='btn btn-gebo' >send message</a>&nbsp;&nbsp;<a href='timeline.php?req_to=$value[Email]' class='btn btn-gebo' >Time Line</a></small>
                                    </div>
                                    </div>";    
                                    header('Location:dashboard.php');              
                                  ...
                                  elseif($value['group_status']=='yes' && ($group1!=$_SESSION['group_name'])){
                                   ...
                                   <span class='searchNb'>1</span>
                                    ...
                                    <div class='search_content'>
                                        ...
                                        <p class='sepH_b item_description'>$value[Email]</p>
                                        <p class='sepH_a'><strong>$value[sign]</strong> </p>
                                        <small><form action=search_page1.php method=POST>
                                        <input type=hidden value=$value[Email] name=email>
                                        <input type=hidden value=$value[Id] name=id>
                                        <input type=hidden value=$value[First_Name] name=g_name>
                                        <input type=submit class='btn btn-gebo' value='join group' name='submit'>                                      
                                        </form>
                                    </div>
                                    </div>"; 
                                    header('Location:dashboard.php'); 
                                  ...
                                  else
                                  {
                                   ...
                                   <span class='searchNb'>1</span>
                                    ...
                                    <div class='search_content'>
                                        ...
                                        <p class='sepH_b item_description'>$value[Email]</p>
                                        <p class='sepH_a'><strong>$value[sign]</strong></p>
                                        <small><a href='search_page1.php?req_to=$value[Email]' class='btn btn-gebo' >send request</a>&nbsp;&nbsp;<a href='timeline.php?req_to=$value[Email]' class='btn btn-gebo' >Time Line</a></small>
                                    </div>
                                    </div>";   
                                    header('Location:dashboard.php'); 
                               ...
                               elseif(isset($search1['error'])){

                                    echo "<div class='alert alert-error'>                                
                               <strong><li>No search result found.</li>!</strong></div>";   
                                   }           
					...
					<div class="antiscroll-inner">
						<div class="antiscroll-content">
							<div class="sidebar_filters">
                                ...
                                <form action ="search_page1.php" method="POST">
