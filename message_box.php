...
$message=$user->message_box($_SESSION['email'],$_GET['msg_type']);
                    ...
                    <div class="row-fluid search_page">
                        <div class="span12">
                            ...
                            <div class="well clearfix">
                                <div class="row-fluid">
                                    <div class="pull-left">Showing <?php echo count($message['success']);?> Message</div>
                             ...
                             <div class="search_panel clearfix">
                                  ...
                                  foreach($message['success'] as $value){



                                    if($_GET['msg_type']=="all"){

                                        if($value['message_to']==$_SESSION['email']){
                                   ...
                                   <span class='searchNb'>1</span>
                                    <div class='thumbnail pull-left'>
                                        <img src=http://placehold.it/80x80/efefef>
                                 </div>
                                    ...
                                    <h4>
                                        ...
                                        <p class='sepH_b item_description'>$value[message_by]</p>
                                        <p class='sepH_b item_description'>Message recived at &nbsp;$value[timestamp]</p>
                                        <p class='sepH_a'><strong>Recived Message</strong> </p>
                                    </div>
                                    </div>";                  
                                                                
                                  } 
                                   
                                  else if($value['message_by']==$_SESSION['email']){

                                     if($value['message_by']==$_SESSION['email']){
                                   ...
                                   <span class='searchNb'>1</span>
                                    ...
                                    <div class='search_content'>
                                        ...
                                        <p class='sepH_b item_description'>$value[message_to]</p>
                                         <p class='sepH_b item_description'>Message send at &nbsp;$value[timestamp]</p>
                                        <p class='sepH_a'><strong>Send Message</strong> </p>
                              ...
                              elseif(isset($message['error']))
                              {
                               ...
                               <strong><li>$messages[error]</li>!</strong></div>"; 
