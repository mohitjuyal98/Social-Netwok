...
if(is_array($login1)){
	if(isset($login1['success'])){
		session_start();
		$_SESSION['user_id']=$login1['success']['user_id'];
		...
		<div class="login_box">
			...
			<form action="login.php" method="post" id="reg_form" style="display:none">
				...
				<div class="cnt_b">
					...
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="text" placeholder="Reenter Password " />
						</div>
					</div>
					 ...
					 <div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="text" placeholder="First name" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-lock"></i></span><input type="text" placeholder="Last name" />
						</div>
					</div>
